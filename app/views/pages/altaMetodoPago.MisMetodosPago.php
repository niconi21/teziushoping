...
<div class="container mt-5">
    <form class="row animate__animated animate__fadeInLeft" action="
            ...
            <div class="card  bg-fondo text-white">
                ...
                <div class="card-body">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control mb-4" placeholder="Nombre del titular" name="titular" value="<?php echo $result->titular ?>" required>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
    ...
    <div class="row">
        <div class="col">
            <button type="submit" class="btn btn-success btn-block"><?php echo $tipo == 'put' ? 'Actualizar' : 'Agregar'; ?> método de pago</button>
        </div>
    </div>
</div>
